...
campsiteRouter
  ...
  .get((req, res, next) => {
    Campsite.find()
      //directs app upon retrieval of campsites, populate the author field of comments sub document
      //by finding the user document that matches the object id stored
...
campsiteRouter
  ...
  .post(authenticate.verifyUser, (req, res, next) => {
    Campsite.findById(req.params.campsiteId)
      .then((campsite) => {
        if (campsite) {
          //Add id of current user to request body as author before being pushed into-
          //comments array
  ...
  .delete(
    ...
    (req, res, next) => {
      Campsite.findById(req.params.campsiteId)
        .then((campsite) => {
          //Deleting every comment, accessing each comment in the comments sub document array one at a time
          //Using method _id() and remove()
          if (campsite) {
